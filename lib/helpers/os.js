...
// // TODO: This function should be implemented using Reconfix
// const injectBalenaConfiguration = async (image: string, configuration: any, partition = 1) => {
// 	try {
// 		await imagefs.interact(image, partition, async () => {
...
// // TODO: This function should be implemented using Reconfix
// const injectNetworkConfiguration = async (image: string, configuration: any, partition = 1) => {
// 	if (configuration.wireless == null) {
// 		return;
// 	}
// 	if (configuration.wireless.ssid == null) {
...
// 	 * @category helper
// 	 */
// 	async readOsRelease(image: string = this.image.path) {
// 		const readVersion = async (pattern: RegExp, field: string) => {
// 			this.logger.log(`Checking ${field} in os-release`);
// 			try {
// 				let value = await imagefs.interact(image, this.bootPartition, async () => {
// 					return await fs.promises.readFile('/os-release')
// 				})
// 				value = pattern.exec(value.toString());
...
// 				try {
// 					let value1 = await imagefs.interact(image, this.bootPartition + 1, async () => {
// 						return await fs.promises.readFile('/usr/lib/os-release')
// 					});
// 					value1 = pattern.exec(value1.toString());
// 					if (value1 !== null) {
// 						this.releaseInfo[field] = value1[1];
...
// 		if (this.configJson) {
// 			await injectBalenaConfiguration(this.image.path, this.configJson, this.bootPartition);
// 			this.logger.log('injected balena config')
// 		}
// 		this.logger.log('staretd network config')
// 		await injectNetworkConfiguration(this.image.path, this.network, this.bootPartition);
// 		this.logger.log('injected network config')
// 	}
// }
